...
export const EMPLOYEES = [
  // DLMS Department
  { hrCode: '1220144', name: 'Omar Mahmoud Abdelhady', email: 'omar.mahmoud@azka.com.eg', department: 'DLMS', experience: 7, title: 'TeamLead', reporter: 'mohamed.essa@azka.com.eg' },
  { hrCode: '1230077', name: 'Mohamed Elsayed Mohamed', email: 'mohamed.hamed@azka.com.eg', department: 'DLMS', experience: 3, title: 'Senior', reporter: 'mervat.abdelrahman@azka.com.eg' },
  { hrCode: '1230087', name: 'Hesham Galal Mostafa', email: 'hesham.galal@azka.com.eg', department: 'DLMS', experience: 5, title: 'Senior', reporter: 'omar.mahmoud@azka.com.eg' },
  { hrCode: '1220035', name: 'Abdelrahman Moussa', email: 'abdelrahman.moussa@azka.com.eg', department: 'DLMS', experience: 4, title: 'Senior', reporter: 'omar.mahmoud@azka.com.eg' },
  ...
  { hrCode: '5240043', name: 'Mohamed Ashraf Merdan', email: 'mohamed.merdan@azka.com.eg', department: 'Flow', experience: 5, title: 'Senior', reporter: 'mervat.abdelrahman@azka.com.eg' },
  { hrCode: '1230061', name: 'Mohamed Sayed Shahin', email: 'mohamed.shaheen@azka.com.eg', department: 'Flow', experience: 4, title: 'Junior', reporter: 'mervat.abdelrahman@azka.com.eg' },
  { hrCode: '1230081', name: 'Nahla Hussien Rizk', email: 'nahla.hussin@azka.com.eg', department: 'Flow', experience: 5, title: 'Junior', reporter: 'mervat.abdelrahman@azka.com.eg' },
  { hrCode: '1190200', name: 'Ahmed ElSayed Abd Elkader', email: 'ahmed.elsayed@azka.com.eg', department: 'Flow', experience: 6, title: 'Senior', reporter: 'mervat.abdelrahman@azka.com.eg' },
  { hrCode: '1220108', name: 'Muaaz Rashad Sewilam', email: 'muaaz.rashad@azka.com.eg', department: 'Flow', experience: 5, title: 'Junior', reporter: 'mohamed.taman@azka.com.eg' },
  { hrCode: '1220247', name: 'Samar M. Abdolmonem', email: 'samar.mohamed@azka.com.eg', department: 'Flow', experience: 3, title: 'Junior', reporter: 'mohamed.taman@azka.com.eg' },
  ...
  { hrCode: '1220112', name: 'Muhammad Hassan Hafez', email: 'hassan.hafez@azka.com.eg', department: 'Prepaid', experience: 5, title: 'Junior', reporter: 'ahmed.gaber@azka.com.eg' },
  // R&D Department
  { hrCode: '1230083', name: 'Ahmed A. Elzoughby', email: 'ahmed.abdeltawab@azka.com.eg', department: 'R&D', experience: 7, title: 'Senior', reporter: 'saif.eldin@azka.com.eg' },
  ...
  { hrCode: '1220106', name: 'Mahmoud M. Youness', email: 'mahmoud.youness@azka.com.eg', department: 'R&D', experience: null, title: 'N/A', reporter: 'saif.eldin@azka.com.eg' },
...
/**
 * Get reporter email for an employee (per-employee assignment)
 */
export function getReporterEmail(email) {
  const employee = EMPLOYEES.find(
    (e) => e.email.toLowerCase() === email.toLowerCase()
  );
  return employee?.reporter || null;
}
